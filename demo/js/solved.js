    ...
    queryForAnswer.find().then(function (answers) {
        answers.forEach(function (answer) {
            ...
            imageFile.fetch().then(function () {
               ...
               if(imageUrl && status){//有图有被采纳的最佳回答
                   html = `
                    <li data-id="${answerID}">
                        <div class="headline">
                            <i class="iconfont icon-trophy best-answer"></i>
                            <span class="answer-title">最佳答案</span>
                        </div>
               ...
               }else if (!imageUrl && status) {//没有图有最佳回答
                   html = `
                    <li data-id="${answerID}">
                        <div class="headline">
                            <i class="iconfont icon-trophy best-answer"></i>
               ...
               }else if (imageUrl && !status) {//有图没有最佳回答
                    html = `
                    <li data-id="${answerID}">
